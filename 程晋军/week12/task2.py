...
def get_sentiment_analysis(text):
    """Analyzes the sentiment of a given text using Qwen model."""
    try:
        # 使用更清晰的指令引导千问模型
        prompt = f"请分析以下文本的情感倾向，只需回答'正面'、'负面'或'中性'：{text}"

        response = requests.post(
            "https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions",
            headers={
                "Authorization": "Bearer sk-8dfd0034a9d7404b827dad9b02e1e9d4",
