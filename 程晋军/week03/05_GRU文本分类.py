...
dataset = pd.read_csv(r"C:\Users\share\AppData\Local\Kingsoft\WPS Cloud Files\userdata\qing\filecache\WPSDrive\438161609\WPS云盘\BADOU/Week01/dataset.csv", sep="\t", header=None)
