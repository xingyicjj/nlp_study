import sys
sys.path.append('/home/bmq/project/bd/Week04')
...
tokenizer = AutoTokenizer.from_pretrained(BERT_MODEL_PKL_PATH)
model = BertForSequenceClassification.from_pretrained(BERT_MODEL_PKL_PATH, num_labels=2)
