...
# 加载和预处理数据
original_df = pd.read_csv('../assets/dataset/waimai_10k.csv', sep=',', header=None)
dataset_df = original_df.sample(frac=1, random_state=42).reset_index(drop=True)
