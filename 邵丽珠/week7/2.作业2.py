...
def main():
    ...
    # 1. 加载数据
    print("加载数据...")
    train_ds = prepare_dataset(train_lines,train_tags)
    eval_ds = prepare_dataset(val_lines,val_tags)
...
def test_single_example():
    ...
    # 测试预测
    test_text = "中 共 中 央 致 中 国 致 公 党 十 一 大 的 贺 词 各 位 代 表 、 各 位 同 志 ： 在 中 国 致 公 党 第 十 一 次 全 国 代 表 大 会 隆 重 召 开 之 际 ， 中 国 共 产 党 中 央 委 员 会 谨 向 大 会 表 示 热 烈 的 祝 贺 ， 向 致 公 党 的 同 志 们 致 以 亲 切 的 问 候 ！"
