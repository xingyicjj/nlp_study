...
dataset = pd.read_csv("./week_data_waimai_10k.csv", sep=",")
# print(dataset['label'])
...
# 返回字典包含：input_ids,attention_mask,token_type_ids
...
torch.save(model.state_dict(),'../../../01-intent-classify/assets/weights/week_bert.pt')
